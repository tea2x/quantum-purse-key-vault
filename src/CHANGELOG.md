...
**This release introduces incompatible changes to key derivation. Keys generated with v0.2.6 will be DIFFERENT from those generated with v0.2.5 and earlier.**
...
- **Switched from Scrypt-based KDF to HKDF-SHA256 for child key derivation**
  ...
  - **Migration Impact**: Users MUST re-derive and update all their addresses
