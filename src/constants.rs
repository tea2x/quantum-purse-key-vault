...
/// is never exposed remotely/locally. It is also the responsibility of the end-users to always lock their device carefully.
/// 
/// Second protection layer: Should the first protection layer fail in any situation, the encryption itself stands as the last resistance
...
/// 
/// At this second protection layer we have:
